...
{
    public class NovaSaveRequest : MethodProperties
    {
        ...
        public NovaSaveRequest(string payerType, string paymentMethod, string dateTime, string cargoType, 
            string weight, string serviceType, string seatsAmount, string description, string cost, string citySender, 
            string sender, string senderAddress, string contactSender, string sendersPhone, string cityRecipient, string recipient, 
            string recipientAddress, string contactRecipient, string recipientsPhone)
        {
            PayerType = payerType;
